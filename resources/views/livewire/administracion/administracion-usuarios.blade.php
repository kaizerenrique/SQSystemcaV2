        ...
        <x-slot name="content">
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-4">
                ...
                <div class="col-span-2 sm:col-span-4 md:col-span-4">
                    ...
                    <x-input type="email" class="mt-1 input input-bordered w-full rounded-lg"
                        wire:model="correo" />
                ...
                <div class="col-span-2 sm:col-span-2">
                    ...
                    <select name="codigo_internacional" id="codigo_internacional"
                        wire:model="codigo_internacional"
